...
void AVLTree::LL_Adjust(TreeNode * &node1)
{
	TreeNode * node;
	node = node1->lchild;
...
void AVLTree::RR_Adjust(TreeNode * &node2)
{
	TreeNode * node;
	node = node2->rchild;
...
void AVLTree::LR_Adjust(TreeNode * &node3)
{
	RR_Adjust(node3->lchild);
	LL_Adjust(node3);
}

void AVLTree::RL_Adjust(TreeNode * &node4)
{
	LL_Adjust(node4->rchild);
	RR_Adjust(node4);
}
